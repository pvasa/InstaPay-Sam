...
public class Utils {
    ...
    static String serialize (Object obj) throws IOException {
        try (ByteArrayOutputStream b = new ByteArrayOutputStream()) {
            ...
            return new String(Base64.encode(b.toByteArray(), Base64.NO_PADDING), "UTF-8");
        }
    }

    static Object deserialize (String s) throws IOException, ClassNotFoundException {
        try (ByteArrayInputStream b = new ByteArrayInputStream(
                Base64.decode(s.getBytes("UTF-8"), Base64.NO_PADDING))) {
