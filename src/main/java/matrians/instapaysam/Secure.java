...
public class Secure implements AutoCloseable {
    ...
    /**
     * The private and unique constructor, you should use the Secure.Builder to build your own
     * instance or get the default proving just the sensible information about encryption
     */
    private Secure(Builder builder) {
        mBuilder = builder;
    }

    /**
     * @return an default encryption instance or {@code null} if occur some Exception, you can
     * create yur own Secure instance using the Secure.Builder
     */
    public static Secure getDefault(String key, String salt, byte[] iv) {
        try {
    ...
    public String encrypt(String data) throws UnsupportedEncodingException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, InvalidKeyException, InvalidKeySpecException, BadPaddingException, IllegalBlockSizeException {
        ...
        cipher.init(Cipher.ENCRYPT_MODE, secretKey,
                mBuilder.getIvParameterSpec(), mBuilder.getSecureRandom());
    ...
    /**
     * This class is used to create an Secure instance, you should provide ALL data or start
    ...
    public static class Builder {
        ...
        /**
         * Build the Secure with the provided information
         *
         * @return a new Secure instance with provided information
         *
         ...
         */
        public Secure build() throws NoSuchAlgorithmException {
