 ...
 */
public class BarcodeCaptureFrag extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        gestureDetector = new GestureDetector(view.getContext(), new CaptureGestureListener());
        ...
        Snackbar.make(getActivity().findViewById(R.id.fab), "Tap to capture. Pinch/Stretch to zoom",
    ...
    private void requestCameraPermission() {
        ...
        Snackbar.make(mGraphicOverlay, R.string.alertPermissionRequest,
    ...
    private void createCameraSource(boolean autoFocus, boolean useFlash) {
        ...
        if (!barcodeDetector.isOperational()) {
            ...
            if (hasLowStorage) {
                Toast.makeText(getActivity(), "Low storage", Toast.LENGTH_LONG).show();
        ...
        // to other detection examples to enable the barcode detector to detect small barcodes
        // at long distances.
        CameraSource.Builder builder = new CameraSource.Builder(getActivity()
