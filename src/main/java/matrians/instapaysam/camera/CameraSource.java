 ...
 * </ul>
 */
@SuppressWarnings({"deprecation", "WeakerAccess", "unused", "FieldCanBeLocal"})
class CameraSource {
    ...
    CameraSource start() throws IOException {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                return this;
            }
     ...
     */
    void takePicture(ShutterCallback shutter, PictureCallback jpeg) {
        synchronized (mCameraLock) {
            if (mCamera != null) {
     ...
     * @see #getFocusMode()
     */
    boolean setFocusMode(@FocusMode String mode) {
        synchronized (mCameraLock) {
    ...
    boolean setAutoFocusMoveCallback(@Nullable AutoFocusMoveCallback cb) {
